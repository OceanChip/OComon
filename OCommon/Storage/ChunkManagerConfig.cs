...
namespace OceanChip.Common.Storage
{
    public class ChunkManagerConfig
    {
        ...
        /// <summary>
        /// Chunk文件大小，字节为单位，适用于文件内记录大小不固定的场景，如果是固定大小，则设置为0;
        /// </summary>
        public readonly int ChunkDataSize;
        /// <summary>
        /// Chunk文件单条数据大小，字节为单位，适用于每条数据固定大小的场景
        /// </summary>
        public readonly int ChunkDataUnitSize;
        /// <summary>
        /// Chunk文件总数据数，适用于每个数据固定大小的场景
        /// </summary>
                               ...
                               bool enableChunkStatistic)
        {
            ...
            {
                throw new ArgumentException(string.Format("无效块数据大小参数. chunkDataSize: {0}, chunkDataUnitSize: {1}, chunkDataCount: {2}", chunkDataSize, chunkDataUnitSize, chunkDataCount));
            }
            ...
            {
                throw new ArgumentException("Chunk数据不能大于1G");
            }
        }
