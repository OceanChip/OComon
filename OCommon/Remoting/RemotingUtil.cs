...
namespace OceanChip.Common.Remoting
{
    ...
    {
        private static readonly object rresponseCodeBytes;
        ...
        public static byte[] BuildRequestMessage(RemotingRequest request)
        {
            ...
            return ByteUtil.Combine(idLengthBytes, idBytes,
                sequenceBytes, codeBytes,
                typeBytes, createdTimeBytes,
                headerLengthBytes, headerBytes,
                request.Body);
        }
    ...
    public static byte[] BuildResponseMessage(RemotingResponse response)
    {
        ...
        var requestCodeBytes = BitConverter.GetBytes(response.RequestCode);
            ...
            return ByteUtil.Combine(requestSequenceBytes,
                requestCodeBytes, requestTypeBytes,
                requestTimeBytes, requestHeaderLengthBytes,
                requestHeaderBytes, responseCodeBytes,
                responseTimeBytes, responseHeaderLengthBytes,
                responseHeaderBytes, response.ResponseBody);
        }
        public static RemotingResponse ParseResponse(byte[] data)
        {
            ...
            return new RemotingResponse(
                requestType, requestCode, requestSequence,
                requestTime, responseCode, responseBody,
                responseTime,
